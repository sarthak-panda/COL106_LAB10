...
struct TwoFourTree {
    ...
    //
    // Note: Although splitAndFix Implementation is given to you,
    //       But Please Try to Implement it yourself, If you are
    //       facing difficulty, Go through it carefully and Make 
